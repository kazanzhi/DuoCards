...
export const LearnHeader: React.FC<Props> = ({ cardId }) => {
    return (
            ...
            <Container fluid >
                <Row style={{ justifyContent: 'center' }}>
                    ...
                    <Col sm={6} md={5} lg={4} xl={3} style={{ display: 'flex', justifyContent: 'end' }}>
                        <Button href={`/edit/${cardId}`} variant='outline' className='rounded-circle' style={{ border: 'none' }}>
                        ...
                        <Button href='/create' variant='outline' className='rounded-circle' style={{ border: 'none' }}>
