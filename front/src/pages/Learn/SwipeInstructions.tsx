...
export default function SwipeInstructions({ }: Props) {
    return (
        <Row style={{ position: "absolute", zIndex: 100, width: '100%', paddingTop: '30px', fontSize: '20px' }}>
            <Col style={{ color: '#E98585', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <svg xmlns="http://www.w3.org/2000/svg" height="27" width="23" fill="#E98585" viewBox="0 0 448 512">
            ...
            <Col style={{ color: '#4CB74C', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <svg xmlns="http://www.w3.org/2000/svg" height="27" width="23" fill="#4CB74C" viewBox="0 0 448 512">
